...
class ProductUserDatasource {
  final http.Client _client;
  ProductUserDatasource({http.Client? client})
      : _client = client ?? http.Client();

    Future<Either<String, List<CustomerProductPrice>>> getProductsByUser() async {
      try {
        ...
        final url = Uri.parse(
          '${Variables.baseUrl}/user/products',
        );
