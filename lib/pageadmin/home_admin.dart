...
import 'package:yofa/pageadmin/karyawanku/karyawanku.dart';
import 'package:yofa/pageadmin/sales/sales.dart';
...
class _HomeAdminPageState extends State<HomeAdminPage> {
  ...
  Widget _profileCard() {
    return FutureBuilder<AuthResponseModel?>(
      future: AuthLocalDatasource()
          .getAuthData(), // pastikan return AuthResponseModel?
        ...
        itemBuilder: (context, i) {
          ...
          return InkWell(
            onTap: () {
              ...
              if (it.label == 'Karyawanku') {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const KaryawankuPage()),
                );
                return;
              }
              if (it.label == 'Sales') {
  ...
  Widget _statGrid() {
    final stats = [
      ...
      _StatData('Invoice', '0', Icons.receipt_long_rounded, false),
      _StatData('Customer', '0', Icons.people_rounded, false),
      _StatData('Sales', 'Rp. 0', Icons.monetization_on_rounded, true),
