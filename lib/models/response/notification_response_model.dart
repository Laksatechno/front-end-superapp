...
///jumlah notifikasi
class CountNotificationResponseModel {
  String? status;
  String? message;
  NotificationCounterData? data;

  CountNotificationResponseModel({
    this.status,
    this.message,
    this.data,
  });

  factory CountNotificationResponseModel.fromJson(String str) =>
      CountNotificationResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory CountNotificationResponseModel.fromMap(Map<String, dynamic> json) =>
      CountNotificationResponseModel(
        status: json["status"],
        message: json["message"],
        data: json["data"] == null
            ? null
            : NotificationCounterData.fromMap(json["data"]),
      );
...
class NotificationCounterData {
  ...
  factory NotificationCounterData.fromMap(Map<String, dynamic> json) =>
      NotificationCounterData(
        notificationCounter: json["notifikasi"] ?? 0,
      );

  Map<String, dynamic> toMap() => {
        "notifikasi": notificationCounter,
      };
}
