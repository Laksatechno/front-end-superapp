...
import 'customer_page.dart' show CustomerItem;
...
class _EditCustomerPageState extends State<EditCustomerPage> {
  ...
  final List<String> _areas = ['Jakarta', 'Bogor', 'Depok', 'Tangerang', 'Bekasi','Sleman'];
          ...
          _card(
            child: Column(
              ...
              children: [
                ...
                TextField(controller: _nameCtrl, decoration: _dec('Nama customer...', icon: Icons.person_outline)),

                const SizedBox(height: 12),
                const Text('No HP', style: TextStyle(fontWeight: FontWeight.w900, color: AppTheme.textDark)),
                const SizedBox(height: 8),
                TextField(controller: _phoneCtrl, keyboardType: TextInputType.phone, decoration: _dec('No HP...', icon: Icons.phone_iphone_rounded)),

                const SizedBox(height: 12),
                const Text('Email', style: TextStyle(fontWeight: FontWeight.w900, color: AppTheme.textDark)),
                const SizedBox(height: 8),
                TextField(controller: _emailCtrl, keyboardType: TextInputType.emailAddress, decoration: _dec('Email...', icon: Icons.email_outlined)),

                const SizedBox(height: 12),
                const Text('Alamat', style: TextStyle(fontWeight: FontWeight.w900, color: AppTheme.textDark)),
                const SizedBox(height: 8),
                TextField(controller: _addressCtrl, maxLines: 3, decoration: _dec('Alamat...', icon: Icons.location_on_outlined)),
